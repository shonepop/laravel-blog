        ...
        <div class="row">
            <div class="col-md-6">
                <div class="card card-primary">
                    ...
                    <!-- /.card-header -->
                    <!-- form start -->
                    <form role="form" action="{{route('admin.post_categories.update', ["postCategory" => $postCategory->id])}}" method="post">
                        @csrf
                        <div class="card-body">
                            ...
                            <div class="form-group">
                                ...
                                <textarea 
                                    ...
                                    placeholder="Enter description">{{old('description', $postCategory->description)}}</textarea>
